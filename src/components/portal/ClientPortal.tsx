    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-20">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <TabsList className="bg-white dark:bg-zinc-900 p-1 rounded-xl shadow-sm border h-auto flex flex-wrap gap-1">
            <TabsTrigger 
              value="overview"
              className="px-5 py-2 rounded-lg text-xs font-bold uppercase tracking-tighter data-[state=active]:bg-zinc-900 data-[state=active]:text-white shadow-none data-[state=active]:shadow-md transition-all"
            >
          ...
          <div className="flex items-center space-x-2 text-xs font-semibold text-zinc-500 bg-white dark:bg-zinc-900 px-4 py-2 rounded-full border shadow-sm self-start">
