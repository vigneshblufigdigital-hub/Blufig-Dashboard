      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-5 rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-900 shadow-sm">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 px-4 h-9 flex items-center justify-center font-bold text-xs uppercase tracking-wider rounded-lg text-zinc-800 dark:text-zinc-100 border border-zinc-200 min-w-[150px] shadow-inner">
