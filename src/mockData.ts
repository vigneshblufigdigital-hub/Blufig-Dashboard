...
export const MOCK_USERS: UserProfile[] = [
  ...
  },
  {
    ...
    department: Department.WEB_DEVELOPMENT,
    designation: 'HubSpot Developer & Consultant',
    role: UserRole.HUBSPOT_SPECIALIST,
    reportsToId: '036',
    skillTags: ['CRM Implementation', 'Workflows', 'Automation', 'CMS Development']
  },
  {
    id: '056',
    name: 'Subhadip Dey',
  ...
  },
  {
    ...
    isDeptLead: true,
    hierarchyLevel: 'lead',
    skillTags: ['Recruitment', 'Employee Engagement', 'Culture', 'HR Strategy']
  },
  {
    id: '135',
    name: 'Arpana Khawas',
    email: 'arpana@blufig.digital',
    department: Department.HUMAN_RESOURCES,
    designation: 'HR Specialist',
    role: UserRole.HR_SPECIALIST,
    hierarchyLevel: 'specialist',
    skillTags: ['Recruitment', 'Payroll', 'Onboarding']
  },
  {
    id: 'client-1',
    name: 'Sarah Johnson',
